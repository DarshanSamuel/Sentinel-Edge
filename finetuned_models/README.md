...
## Since the finetuned Gemma 2 (2b -it) model GGUF Files have a large size and cannot be directly uploaded in GitHub, I have inserted links to my Google Drve Folder, where the model fils are uploaded. They can be downloaded and directly implemented in the inference scripts
